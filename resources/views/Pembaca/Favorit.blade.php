...
<body class="bg-gray-50">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-yellow-700 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="bookmark-author" class="flex items-center p-2 text-white rounded-lg bg-yellow-800 dark:text-white hover:bg-yellow-900 dark:hover:bg-gray-700 group">
                            ...
                            <div class="fixed flex flex-col mt-[130px] px-4 w-full bg-gray-50">
                                <div class="flex flex-row gep-5 mt-5 mb-5">
                                    ...
                                    <a href="favorit-pembaca">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-200 focus:outline-none rounded-full bg-blue-700 border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Favorite</button>
                                    </a>
                                </div>
                            </div>
                            {{-- Navigasi Bookmark start --}}
