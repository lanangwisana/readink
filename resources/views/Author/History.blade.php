...
<body class="bg-gray-50">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-yellow-700 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="history-author" class="flex items-center p-2 text-white rounded-lg bg-yellow-800 dark:text-white hover:bg-yellow-900 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
            ...
            <div>
                ...
                <div class="z-0">
                    <div class="relative flex flex-row mt-[250px] p-3 border border-gray-50 border-lg shadow rounded w-1/2">
                        ...
                        <div class="absolute top-[80px] left-[550px]">
                            <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-[50px] py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Publish</button>
                        </div>
                    </div>
                    <div class="relative flex flex-row mt-5 p-3 border border-gray-50 border-lg shadow rounded w-1/2">
                        <div class="">
                            <img src="{{ asset('img/kimdokja 1.png') }}" alt="">
                        </div>
                        <div class="flex flex-col ms-5">
