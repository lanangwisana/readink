                ...
                <div class="z-0">
                    <div class="relative flex flex-row mt-[250px] p-3 border border-gray-50 border-lg shadow rounded w-1/2">
                        ...
                        <div class="absolute top-[80px] left-[550px] flex flex-row">
                            <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xl px-[50px] py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><a href="editcerita-author">Edit</a></button>
                            <a href="">
